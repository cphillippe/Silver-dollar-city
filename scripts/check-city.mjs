...
assert.equal(APP_VERSION, '1.4.158')
...
assert.match(latestChange(APP_VERSION).items.join('\n'), /Source Dig|digHunt|Scrub|timer|SOURCE_DIG_HINT|#204|1\.4\.143|1\.4\.147/i)
{
...
assert.match(latestChange(APP_VERSION).title, /Source Dig|how|digHunt/i)
assert.match(latestChange(APP_VERSION).items.join('\n'), /Source Dig|digHunt|Scrub|timer|SOURCE_DIG_HINT|#204|1\.4\.143|1\.4\.147/i)
