...
assert.equal(APP_VERSION, '1.4.157')
...
assert.match(latestChange(APP_VERSION).items.join('\n'), /Home|whisper|snapHome|mergeHome|digHome|One more|#203/i)
{
...
assert.match(latestChange(APP_VERSION).title, /Home|whisper|snap|merge|dig/i)
assert.match(latestChange(APP_VERSION).items.join('\n'), /Home|whisper|snapHome|mergeHome|digHome|One more|#203/i)
