...
assert.equal(APP_VERSION, '1.4.153')
...
assert.match(latestChange(APP_VERSION).items.join('\n'), /Samaritan|board-first|default|chrome|thumbs|beats|#190/i)
{
...
assert.match(latestChange(APP_VERSION).title, /Samaritan|board-first|default/i)
assert.match(latestChange(APP_VERSION).items.join('\n'), /Samaritan|board-first|default|chrome|thumbs|beats|#190/i)
