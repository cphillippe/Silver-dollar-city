...
assert.equal(APP_VERSION, '1.4.142')
...
assert.match(latestChange(APP_VERSION).items.join('\n'), /Lock In|claim-pick|teach-chip|Main idea|1\.4\.140|1\.4\.141/i)
{
...
assert.match(latestChange(APP_VERSION).title, /Lock In|claim-pick|Main idea|cue/i)
assert.match(latestChange(APP_VERSION).items.join('\n'), /Lock In|claim-pick|teach-chip|Main idea|1\.4\.140|1\.4\.141/i)
