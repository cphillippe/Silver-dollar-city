...
assert.equal(APP_VERSION, '1.4.171')
...
assert.match(latestChange(APP_VERSION).items.join('\n'), /Sequence|BuildArgument|≤720|board-first|how|hint|lead/i)
{
...
assert.match(latestChange(APP_VERSION).title, /Sequence|board-first|≤720/i)
assert.match(latestChange(APP_VERSION).items.join('\n'), /Sequence|BuildArgument|≤720|board-first|how|hint|lead/i)
