/**
 * Pure SVG art components for CityMap.
 * Peeled from CityMap.tsx for 1.4.127 — no React state, no hooks.
 * CityMap.tsx imports the public exports; PlotGroup/TownFolk stay there.
 */
import {
  CITY_AGES,
  heavenChip,
...
import { easyTagMetrics, EASY_TAG_SLOT, HEAVEN_TAG } from '../lib/cityBuild'
  ...
  if (stage === 'scaffold') {
    return (
      <>
        ...
        />
        <circle cx="574" cy="254" r="6" className="city-timber" />
      </>
    )
  }
  return (
    <>
      <path className="city-porch" d="M530 330 h72 l6 8 H524 Z" />
      <rect x="536" y="292" width="72" height="38" rx="3" />
      <path className="city-roof" d="M530 292 l36-22 36 22" />
      {stage === 'lit' ? (
        <path className="city-roof city-roof-tile" d="M526 294 l39-26 39 26" />
      ) : null}
      <rect x="552" y="300" width="12" height="14" rx="1" className="city-window" />
      <rect x="574" y="300" width="12" height="14" rx="1" className="city-window" />
      ...
      {stage === 'lit' ? (
        <>
          ...
          <circle className="city-lamp" cx="538" cy="290" r="4.5" />
        </>
      ) : null}
    </>
  )
