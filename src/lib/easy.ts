...
export const EASY = {
  ...
  runCta: 'Run to him',
  runMatch: 'Run',
  runHome: 'Hold to run. Hug him before the speech is done. One more run.',
  runAgain: 'One more run',
  mazeHunt: 'Tap the road. Pick up help. Take him to the inn.',
  mazeCta: 'Help on the road',
  mazeMatch: 'Help',
  mazeHome: 'Help on the road. Take him to the inn. One more road.',
  ...
  digMatch: 'Dig',
  digHome: 'Tap the glowing tablet. Dig the old names. One more dig.',
