...
export const EASY = {
  ...
  holdYes: 'Yes! You got it.',
  holdKept: 'That is the line we keep.',
  bonusToast: '+100 · Extra try!',
  bonusWhy: '100 points for an extra try at Match.',
  moreMatch: 'One more Match',
  bonusHint: 'Other story words hide here. Find one for +100.',
