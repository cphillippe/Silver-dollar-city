...
export const CHANGELOG: ChangeNote[] = [
  {
    ...
    items: [
      ...
      'Learn beats fold into the run as harvest short-story panels flip. Mercy / ph-road stays panel-blast. Hold theology and the locked father-run Easy short story stay verbatim',
      'Easy home names the play: Run after Mercy is held. Night Watch and Town stay hidden on Easy',
      'Queued parable games stay unmounted: Samaritan road-swipe, claim-merge, story-night',
