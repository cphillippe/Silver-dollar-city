...
- `link` — tap idea ↔ place ↔ person blocks. Miss shows Try again. Completing `ln-street` lights those nodes on the town mind map. Hard Link the street uses every claim·reason·source fact (minus Night Watch how-to and trail thank-you cards). Easy Match still uses one taught triad.
