...
export const highLookout: Area = {
  ...
  challenges: [
    ...
    },
    {
      ...
      context:
        'Inner experience is not captured by a scan. The “hard problem” is why physical process is accompanied by felt life at all. Mind is at home when the world’s ground is a living God — not an indifferent process.',
      pairs: [
        {
          id: 'qualia',
          gem: 'heart',
