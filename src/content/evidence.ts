...
export const EVIDENCE: Record<string, EvidenceBrief> = {
  ...
  'ob-tuning': brief(
    ...
    'The constants are necessary; they could not have been otherwise.',
    'A multiverse is a peer explanation with the same evidence as design.',
  ),
  'ob-design': brief(
    'ob-design',
    ...
    'Necessity holds: these numbers could not have been otherwise.',
    'Fine-tuning already proves a particular gospel.',
    'A multiverse is a peer to design — same evidence, equal weight.',
