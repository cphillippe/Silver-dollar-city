...
export const EVIDENCE: Record<string, EvidenceBrief> = {
  ...
  'ob-tuning': brief(
    'ob-tuning',
    'The cosmos is delicately fitted for life.',
    'That fittedness is what a Designer who wanted a habitable world would write into the numbers.',
    ...
    'Fine-tuning is only sensitivity — not yet a Designer.',
    'Naming rival options ends the argument.',
  ),
  'ob-design': brief(
    'ob-design',
    'Fine-tuning is a sound inference to a Designer.',
    'A mind that wanted a habitable world predicts these numbers better than a single throw of chance.',
    'Philosophical fine-tuning literature (Collins)',
