...
Hard-reload once if you still see the old game (the PWA can keep a cached copy). Live bundle is `index-DB20K5c-.js` — Eden → City of Heaven, candy default, theme picker (Dusk town / Clean parchment).
