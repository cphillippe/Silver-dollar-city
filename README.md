...
Hard-reload once if you still see the old game (the PWA can keep a cached copy). Live bundle is `index-Cgp6tRZ-.js` — town overlay gone, candy gem/ability icons, Night Watch divert toward heaven.
