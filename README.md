...
Hard-reload once if you still see the old game (the PWA can keep a cached copy). Live bundle is `index-BQjgprke.js` — Eden → City of Heaven, candy default, early gems, theme picker.
