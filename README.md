...
Hard-reload once if you still see the old game (the PWA can keep a cached copy). Live bundle is `index-f1CrFjSQ.js` — Eden → Heaven, early gems, Night Watch love/logic divert, candy default.
