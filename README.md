...
Hard-reload once if you still see the old game (the PWA can keep a cached copy). Live bundle is `index-BOb4eb0Z.js` — town overlay gone, candy gems, Learn → Hold → Deploy.
