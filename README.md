...
Hard-reload once if you still see the old game (the PWA can keep a cached copy). Live bundle is `index-B8gbweUq.js` — catalog-driven Night Watch, four tools with mastery tiers, Learn → Hold → Deploy, town overlay gone.
