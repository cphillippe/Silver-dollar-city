...
- **Lock-in explosion:** on success a gold **Locked!** stamp hits, the board flashes, tiles pop and fly clear, sparks burst (~760ms), then takeaway chips. Progress saves after the juice so the board is not remounted mid-burst.
